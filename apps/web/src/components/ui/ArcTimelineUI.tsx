...
export default function ArcTimelineUI(props: ArcTimelineProps) {
    const { className, data, arcConfig = {}, defaultActiveStep = {}, ...restProps } = props;
    ...
    const { time: defaultActiveTime = data[0]?.time, stepIndex: defaultActiveStepIndex = 0 } =
        defaultActiveStep || {};
